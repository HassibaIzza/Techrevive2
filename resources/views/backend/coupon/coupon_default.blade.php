        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    bx-home-alt"></i></a></li>
                    <li class="breadcrumb-item active" aria-current="page">Liste des coupons</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                @if(Auth::user()->role == "vendor")
                    <div class="ms-auto" style="margin-bottom: 20px">
                        <a href="add_coupon" class="btn btn-primary radius-30 mt-2 mt-lg-0">
                            <i class="bx bxs-plus-square"></i>Ajouter un nouveau coupon</a></div>
                @endif
                                        ...
                                        <div class="modal-dialog modal-fullscreen">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Modifier le coupon</h5>
                                        ...
                                        <div class="modal fade" id="exampleDangerModal-{{$item->coupon_id}}"
                                            ...
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content bg-danger">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title text-white">Surrement ?</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-footer">
