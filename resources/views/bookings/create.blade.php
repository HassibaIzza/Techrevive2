        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ajouter un rendez_vous</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="brand_form" action="{{route('marque.create')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-sm-9 text-secondary">
                    <input name="date" type="text" class="form-control datetimepicker" id="datepicker" required />
